...
import w_pawn from "./w_pawn.png";
import w_queen from "./w_queen.png";
import w_rook from "./w_rook.png";

export default { b_bishop, b_king, b_knight, b_pawn, b_queen, b_rook ,w_bishop, w_king, w_knight, w_pawn, w_queen, w_rook};
